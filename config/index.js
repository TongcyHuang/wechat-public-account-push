export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx6cbef18a4cf5b6fb",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5f1edb77880f7ed6ddfad4986dc6881b",
   ...
   */
  USERS: ["o5ftX66MqzMLN3z18e-OQoD2C6Mo"]
    {
      // 想要发送的人的名字
      name: "老婆0",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "E0jTkVEiqyCwu3T_FCPN8I4pwOvaHWDa7ggeJ2BhUx8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "E0jTkVEiqyCwu3T_FCPN8I4pwOvaHWDa7ggeJ2BhUx8",
      // 所在省份
      province: "陕西",
      // 所在城市
      city: "西安",
